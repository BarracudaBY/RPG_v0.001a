...
public class Enemy_Slime : Enemy
{
	...
	[SerializeField] protected Vector2 minCreationVelocity;
	[SerializeField] protected Vector2 maxCreationVelocity;
	...
	public override void Die()
	{
		...
		CreatesSlimes(slimesToCreate, slimePrefab);

	}
	
	
	private void CreatesSlimes(int _amoutOfSlimes, GameObject _slimePrefab)
	{
